...
const createMovieDetailTemplate = (movie) => `
  ...
  <img loading="lazy" class="movie__poster" src="${CONFIG.BASE_IMAGE_URL + movie.poster_path}" alt="${movie.title}" />
  ...
  <div class="movie-item">
    <div class="movie-item__header">
      <a href="${`/#/detail/${movie.id}`}">
        <img loading="lazy" draggable="false" class="movie-item__header__poster" alt="${movie.title}"
